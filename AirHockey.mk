...
$(IntermediateDirectory)/ECS_ECS.cpp$(ObjectSuffix): ECS/ECS.cpp $(IntermediateDirectory)/ECS_ECS.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "ECS/ECS.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ECS_ECS.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/audio.cpp$(ObjectSuffix): audio.cpp $(IntermediateDirectory)/audio.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "audio.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/audio.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/engine.cpp$(ObjectSuffix): engine.cpp $(IntermediateDirectory)/engine.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "engine.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/engine.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Vector2D.cpp$(ObjectSuffix): Vector2D.cpp $(IntermediateDirectory)/Vector2D.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "Vector2D.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Vector2D.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/EventHandler.cpp$(ObjectSuffix): EventHandler.cpp $(IntermediateDirectory)/EventHandler.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "EventHandler.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/EventHandler.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Collision.cpp$(ObjectSuffix): Collision.cpp $(IntermediateDirectory)/Collision.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "Collision.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Collision.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/TextureManager.cpp$(ObjectSuffix): TextureManager.cpp $(IntermediateDirectory)/TextureManager.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "TextureManager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/TextureManager.cpp$(ObjectSuffix) $(IncludePath)
